...
const CompanySchema = z.object({
  ...
  publicEmail: z.email().nullish(),
  website: z.url().nullish(),

  publicEmailLegacyLike: z.string().max(191).nullish(),
  phone: z.string().max(64).nullish(),
  address: z.string().max(255).nullish(),
  city: z.string().max(191).nullish(),
  state: z.string().max(191).nullish(),
  zip: z.string().max(32).nullish(),
